...
[`@aws-sdk/client-codeguruprofiler`](https://www.npmjs.com/package/@aws-sdk/client-codeguruprofiler/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguruprofiler@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VYCp/BPF95n8cbk/z4hIjoSTAzp1HWMAUmaxztceUVsFDAcrWz+XTuGM0lPHWLTK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codeguruprofiler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguruprofiler@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeguruprofiler@3.150.0/index.min.mjs": "sha384-VYCp/BPF95n8cbk/z4hIjoSTAzp1HWMAUmaxztceUVsFDAcrWz+XTuGM0lPHWLTK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codeguruprofiler/blob/refs/tags/3.150.0/LICENSE
```
